...
int main() {
  ...
  // start in lane 1. (the middle lane)
  int lane = 1;
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          {    
            ...
            // if using previous points can projects s value outwards in time
          ...
          //In Frenet add evenly 30m spaced points ahead pf the starting reference
          ...
          for (int i=1; i <= 50-previous_path_x.size(); i++){
            ...
            double N = target_dist / (0.02 * ref_vel / 2.24); // 2.24 for transforming mph to m/s
